    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                product = new SimpleProduct_1.SimpleProduct(null, 'Random Act of Kindness');
                return [4 /*yield*/, session.store(product)];
            case 1:
                _a.sent();
                return [4 /*yield*/, session.saveChanges()];
            case 2:
                _a.sent();
                console.log(product instanceof SimpleProduct_1.SimpleProduct); // true
                return [4 /*yield*/, session.load('SimpleProducts/1-A')];
            case 3:
